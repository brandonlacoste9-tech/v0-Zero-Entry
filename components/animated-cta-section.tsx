    ...
    <section className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto">
        ...
        >
          ...
          >
            Join 10,000+ accountants and analysts who save hours every week with Zero Entry's AI-powered document
            processing.
          </p>
          <div
          ...
          >
            <Button size="lg" className="bg-emerald-500 text-white hover:bg-emerald-600 group" asChild>
